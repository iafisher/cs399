...
Privacy policies are represented in \textsc{Racets} as predicates which take an argument and return a boolean value indicating whether the argument satisfies the policy or not. They are declared with the \texttt{let-label} form:
