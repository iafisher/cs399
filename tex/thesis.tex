...
$$ \text{4. } \langle v, \rho, \textbf{fn}((\lambda x.e), \rho', \kappda) \rangle \to \langle e, \rho'[x \mapsto (v, \rho)], \kappa \rangle $$
...
TODO: How do we get an abstract interpreter from these abstract machines?
